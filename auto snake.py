...
class Game(arcade.Window):
    ...
    def on_draw(self):
        ...
        self.food.draw()
        self.poop.draw()
        arcade.draw_text(f"Score: {self.score}", 10, 20, arcade.color.LEMON, 14)
    ...
    def on_update(self, delta_time: 0.001):
        if self.snake.center_x >= 495 or self.snake.center_x <= 5 or self.snake.center_y >= 495 or self.snake.center_y <= 5:
